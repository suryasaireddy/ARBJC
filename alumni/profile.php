    ...
    <div class = "bg">
        ...
        <div class = "sidenav">
            <ul class = "links">
                ...
                <li class="item"><a href="jobs.php">Post Job</a></li>
        ...
        <div class = "msgBox"> 
            ...
            <div class="form-content" align = "center">
                    <form action="" method = "post">
                        ...
                        <div class="form-ele">
                            <label for="jobRole" style = "padding-left: 5px; font-size: 20px;">Company : </label>
                            <input type="text" name="CompName" style = "font-size: 20px; margin-top:0;" required value = "<?php echo $company; ?>"  readOnly/>
                        </div>
